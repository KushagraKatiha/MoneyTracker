...
function Home() {
  ...
  return (
    <div className='bg-black py-10'>
      <Container className="max-w-lg mx-auto p-5 bg-white/75 rounded-lg shadow-lg">
          ...
          <table className="min-w-full bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <tbody>
              ...
              <tr className="bg-gray-200">
                ...
                <td colSpan="2" className="py-2 px-4 text-center font-semibold">{totalExpenditure}</td>
              </tr>
            </tbody>
          </table>
        </div>
